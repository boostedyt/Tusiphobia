...
const char* partOptions[] = { "Head", "Torso", "Legs" };

float horizontalValue = 6.349f;

float verticalValue = 10.000f;

float cameraSmoothness = 1.000f;
// Data
...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        if (show_menu) {
            ...
            ImGui::Begin("yuki-external", &show_menu);
