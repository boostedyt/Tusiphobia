...
void FirstPersonController_Update_Hook(SFirstPersonController* __this, MethodInfo* method) {
	...
	if (NoClip::enabled) {
		...
		position *= SPlayerStamina::getDeltaTime() * NoClip::speed;
...
//phys8 nothing 4 nuttin
#pragma region Player_1_StartKillingPlayerNetworked
...
//max range pickup
#pragma region Physics_Raycast_12

bool (*Physics_Raycast_12)(app::Ray ray, app::RaycastHit* hitInfo, float maxDistance, int32_t layerMask, app::QueryTriggerInteraction__Enum queryTriggerInteraction, MethodInfo* method);

bool Physics_Raycast_12_Hook(app::Ray ray, app::RaycastHit* hitInfo, float maxDistance, int32_t layerMask, app::QueryTriggerInteraction__Enum queryTriggerInteraction, MethodInfo* method) {
	//printf("\nraycast hook shit\n");

	return Physics_Raycast_12(ray, hitInfo, pickupgang::raycastMaxDistance, layerMask, queryTriggerInteraction, method);
}


#pragma endregion

#pragma region PCPropGrab_OnPickup

void (*PCPropGrab_OnPickup)(app::PCPropGrab* __this, app::InputAction_CallbackContext __1, MethodInfo* method);

void PCPropGrab_OnPickup_Hook(app::PCPropGrab* __this, app::InputAction_CallbackContext __1, MethodInfo* method) {
    //printf("\npcprop grab hook\n");

    return PCPropGrab_OnPickup(__this, __1, method);
}
...
hook(&(LPVOID&) target, target##_Hook);
	//HOOK(Physics_Raycast_10);
	//HOOK(Physics_Raycast_12);
